package soobin.answer.chap04.exam01;
...
public class Ans04 {
	public static void main(String[] args) {
		...
		String[] reverseArr1 = new String[arr1.length];

		for (int i = 0; i < arr1.length; i++) {
			reverseArr1[arr1.length - 1 - i] = arr1[i];
		}

		System.out.println("reverseArr : " + Arrays.toString(reverseArr1));
		...
		for (int i = 0; i < commands.length; i++) {
			...
			Arrays.sort(copyArr);
			result[i] = copyArr[commands[i][2] - 1];
		}
